\question{Волновое уравнение в свободном пространстве (2- и 3-мерные задачи).}

\subquestion{Волны в трёхмерном пространстве}
Рассмотрим задачу:
...
\subquestion{Волны в двумерном пространстве}
