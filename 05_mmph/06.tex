\question{Преобразование неоднородных ГУ в однородные. Преобразование зависящих
от времени ГУ в нулевые.}

\begin{minipage}{.45\textwidth}
    \subquestion{Преобразование неоднородных ГУ в однородные}
...
\begin{minipage}{.48\textwidth}
    \subquestion{Преобразование зависящих от времени ГУ в нулевые}
    \[
        \left. \begin{array}{rl}
            \text{ДУЧП:} & \ds \pder{u}{t} = \alpha^2\ppder{u}{x}, 
            \vspace*{.4em} \\
